            ...
            try:
                with transaction.atomic():
                    ...
                    architect_result = ArchitectAvidityResult.objects.create(specimen=specimen,
                                                                             ...
                                                                             result_treated_SCO=architect_result_row.result_treated_SCO,
                                                                             result_untreated_SCO=architect_result_row.result_untreated_SCO,
                                                                             result_AI=architect_result_row.result_AI,
                                                                             result_AI_recalc=architect_result_row.result_AI_recalc,

            ...
            try:
                if row_num >= 1:
                    ...
                    architect_result_row = ArchitectAvidityResultRow.objects.create(specimen_label=row_dict['specimen_label'],
                                                                                    ...
                                                                                    treated_SCO=row_dict['treated_SCO'],
                                                                                    untreated_SCO=row_dict['untreated_SCO'],
                                                                                    AI=row_dict['AI'],
            ...
            try:
                with transaction.atomic():
                    ...
                    architect_result = ArchitectAvidityResult.objects.create(specimen=specimen,
                                                                             ...
                                                                             well_untreated=architect_result_row.well_untreated,
                                                                             specimen_purpose=architect_result_row.specimen_purpose,
                                                                             treated_SCO=architect_result_row.treated_SCO,
                                                                             untreated_SCO=architect_result_row.untreated_SCO,

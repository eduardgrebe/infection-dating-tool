...
class LSVitrosPlasmaFileHandler(FileHandler):
    ...
    def __init__(self, upload_file):
        ...
        self.assay_name = 'LSVitros-Plasma'
    ...
    def process(self, panel_id, assay_run):
        ...
        from assay.models import (LSVitrosPlasmaResultRow, LSVitrosPlasmaResult,
        ...
        for lsvitros_result_row in LSVitrosPlasmaResultRow.objects.filter(fileinfo=self.upload_file, state='validated'):
            try:
                ...
                with transaction.atomic():
                    ...
                    lsvitros_result_row.error_message = ''
                    lsvitros_result_row.lsvitros_plasma_result = lsvitros_result
                    lsvitros_result_row.save()
                    rows_inserted += 1

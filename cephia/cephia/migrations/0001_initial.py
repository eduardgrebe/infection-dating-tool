    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(max_length=20, choices=[(b'subject', b'Subject'), (b'visit', b'Visit'), (b'transfer_in', b'Transfer In'), (b'aliquot', b'Aliquot'), (b'transfer_out', b'Transfer Out')])),
                ('created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(verbose_name='ID', db_index=True, auto_created=True, blank=True)),
                ('specimen_label', models.CharField(db_index=True, max_length=255, null=True, blank=True)),
                ('parent_label', models.CharField(max_length=255, null=True, blank=True)),
                ('subject_label', models.CharField(db_index=True, max_length=255, null=True, blank=True)),
                ...
                ('visit_linkage', models.CharField(max_length=12, null=True, choices=[(b'provisional', b'Provisional'), (b'confirmed', b'Confirmed'), (b'artificial', b'Artificial')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(verbose_name='ID', db_index=True, auto_created=True, blank=True)),
                ('subject_label', models.CharField(db_index=True, max_length=255, null=True, blank=True)),
                ('cohort_entry_date', models.DateField(db_index=True, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_claimed_volume', models.FloatField(null=True, blank=True)),
                ('aliquoting_reason', models.CharField(max_length=20, null=True, blank=True)),
                ('laboratory', models.ForeignKey(blank=True, to='cephia.Laboratory', null=True)),
                ('shipped_to', models.ForeignKey(blank=True, to='cephia.Location', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('population_group', models.ForeignKey(blank=True, to='cephia.Ethnicity', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(to='cephia.Subject', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hepatitis', models.NullBooleanField()),
                ('artificial', models.BooleanField(default=False)),
                ('source_study', models.ForeignKey(blank=True, to='cephia.Study', null=True)),
        ...
        migrations.AddField(
            model_name='historicalvisit',
            name='subject',
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='cephia.Subject', null=True),
        ),
        migrations.AddField(
            model_name='historicalsubject',
            name='subtype',
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='cephia.Subtype', null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='historicalspecimen',
            name='specimen_type',
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='cephia.SpecimenType', null=True),
        ),
        migrations.AddField(
            model_name='historicalspecimen',
            name='subject',

from outside_eddi.file_handlers.idt_file_handler import FileHandler
...
from outside_eddi.models import IDTSubject, IDTDiagnosticTest, IDTTestPropertyEstimate, TestPropertyMapping, IDTDiagnosticTestHistory
...
class TestsAndPropertiesFileHandler(FileHandler):
    ...
    def import_data(self):
        ...
        from outside_eddi.models import IDTDiagnosticTest, IDTTestPropertyEstimate

# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2017-02-02 11:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_file', models.FileField(upload_to='/home/andrew/id/cephia/cephia/cephia/../../media/outside_eddi_uploads')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='properties', to='outside_eddi.IDTDiagnosticTest')),
                ('user', lib.fields.ProtectedForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', lib.fields.ProtectedForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='outside_eddi.IDTDiagnosticTest')),
                ('test_property', lib.fields.ProtectedForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='outside_eddi.IDTTestPropertyEstimate')),
        ...
        migrations.AddField(
            ...
            name='data_file',
            field=lib.fields.ProtectedForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='test_history', to='outside_eddi.IDTFileInfo'),
        ),
        migrations.AddField(
            model_name='idtdiagnostictesthistory',
            name='subject',
            field=lib.fields.ProtectedForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='idt_test_history', to='outside_eddi.IDTSubject'),
        ),

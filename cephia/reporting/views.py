...
def visit_material(request, template="reporting/visit_material.html"):
    ...
    eddi.ep_ddi AS EP_DDI,
    eddi.lp_ddi AS LP_DDI,
    eddi.interval_size AS DDI_Interval_Size,
    eddi.eddi AS EDDI,
    DATEDIFF(visits.visit_date,eddi.ep_ddi) AS DaysSinceEP_DDI,
    DATEDIFF(visits.visit_date,eddi.lp_ddi) AS DaysSinceLP_DDI,

...
text(t1+3, 0.1, as.character(t1), col = "green")
text(t2-3, 0.1, as.character(t2), col = "green")
text(CI.LB-7, 0.1, as.character(round(CI.LB,2)), col = "blue")
text(CI.UB+7, 0.1, as.character(round(CI.UB,2)), col = "blue")
...
abline(v=CI.LB, col = "blue", lty = 3)
abline(v=CI.UB, col = "blue", lty = 3)
text(t1-7, 0.1, as.character(t1), col = "green")
text(t2+7, 0.1, as.character(t2), col = "green")
text(CI.LB+15, 0.1, as.character(round(CI.LB,2)), col = "blue")
text(CI.UB-15, 0.1, as.character(round(CI.UB,2)), col = "blue")

...
class MailerMessage(models.Model):
    ...
    def add_attachment(self, attachment, name=None, inline_content_id=None):
        """
        ...
        instance = Attachment.objects.create(email=self, name=name, inline_content_id=inline_content_id)
        instance.file_attachment.save(name, attachment)
